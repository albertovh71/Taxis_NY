"""Entrenar y evaluar Linear Regression vs XGBoost."""
...
def train_and_evaluate(
    ...
    # Features (todas excepto pickup_datetime y avg_* que son estadísticas, no predictores)
    feature_cols = [
    ...
    print('COMPARACION')
    print('='*60)
    print(f'{"Métrica":<10} {"Linear":<12} {"XGBoost":<12} {"Mejora (%)"}')
    print('-'*46)
    ...
    print(f'{"R²":<10} {r2_lr:<12.4f} {r2_xgb:<12.4f} {r2_improvement:+.1f}%')
